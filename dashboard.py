...
st.markdown(
    ...
    /* לא רק הפס הוסר - הגלילה האנכית עצמה כבויה לגמרי (14.9.2026, "הסייד
    בר עדיין ניתן לתזוזה למעלה ולמטה... אין בזה צורך") - תוכן הסיידבר גבוה
    מהמסך אצלי (952px מול 720px), אבל אם עדיין יש חלק חתוך בתחתית אצל
    המשתמש בפועל, זה בכוונה - הוא ביקש שלא תהיה אפשרות גלילה בכלל. */
