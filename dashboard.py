...
with st.sidebar:
    ...
    with st.expander("💵 השקעה ויעד רווח"):
        ...
        st.markdown(
            "**גודל התיק הכולל**",
            help="גודל ההשקעה בכל הצעה יחושב לפי כמה מוכן להפסיד בעסקה בודדת "
                 "(אחוז מהתיק הכולל, חלקי מרחק הסטופ) - במקום גודל ההשקעה הרגיל "
                 "הקבוע למעלה. מחושב אוטומטית משווי האחזקות הפתוחות שלך כרגע "
                 "(לא כולל מזומן פנוי שלא הושקע) - לא ניתן לעריכה ידנית. "
                 "0 = אין אחזקות פתוחות כרגע, אז גודל ההשקעה הרגיל למעלה בתוקף.",
        )
