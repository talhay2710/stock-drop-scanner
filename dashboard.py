...
st.markdown(
    ...
    /* פס הגלילה האנכי האמיתי של תוכן הסיידבר - תוכן הסיידבר גבוה מהמסך
    (952px מול 720px גובה זמין), אז stSidebarContent גולל אנכית ומראה פס
    גלילה (14.9.2026, "הסרגל של למעלה/למטה... אפשר להסיר אותו" - עם צילום
    מסך שהראה בבירור פס אנכי, לא ידית רוחב). מסתירים רק את התצוגה החזותית
    של הפס (scrollbar-width/::-webkit-scrollbar) - הגלילה עצמה (עכבר/מגע)
    נשארת עובדת, רק בלי הפס הצף שמפריע ויזואלית. */
