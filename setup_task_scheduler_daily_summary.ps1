...
# at 20:00 (after the US market closes), sending one Telegram digest of the day's alerts.
...
Register-ScheduledTask -TaskName $TaskName -Action $Action -Trigger $Trigger -Settings $Settings -Description "Stock drop scanner - daily Telegram summary at 20:00" -Force
